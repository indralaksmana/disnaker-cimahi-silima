$(document).on('click', '.change_password', function(){
    swal({
        ...
        text: "Silakan masukkan kata sandi Anda saat ini untuk melanjutkan. Jika Anda tidak tahu kata sandi Anda saat ini, keluar dan klik 'Lupa Kata Sandi' pada halaman login.",
        input: 'password',
        inputAttributes: {
            'maxlength': 10,
            'autocapitalize': 'off',
