...
class Paginator
{
    ...
    protected $previousText = 'SEBELUMNYA';
    protected $nextText = 'SELANJUTNYA';
    ...
    public function toHtml()
    {
        ...
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li' . ($page['isCurrent'] ? ' class="active"' : '') . '><a class="page-link" href="' . htmlspecialchars($page['url']) . '">' . htmlspecialchars($page['num']) . '</a></li>';
            } else {
