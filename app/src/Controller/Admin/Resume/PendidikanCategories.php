...
use App\Model\PendidikanCategories as BC;
 ...
 */
class PendidikanCategories extends Controller
{
    ...
    public function categoriesEdit(Request $request, Response $response, $categoryId)
    {
        ...
        return $this->view->render($response, 'bkol/dashboard/blog-categories-edit.twig', ['category' => $category]);
    }
}
