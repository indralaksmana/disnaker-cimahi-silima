...
class Oauth2 extends Controller
{
    ...
    public function providers(Request $request, Response $response)
    {
        ...
        return $this->view->render($response, 'dashboard/oauth2-providers.twig', array("providers" => $providers->get()));
    }
    ...
    public function oauth2Add(Request $request, Response $response)
    {
        ...
        return $this->view->render($response, 'dashboard/oauth2-add.twig', array("bs_social" => $bsSocial));
    }
