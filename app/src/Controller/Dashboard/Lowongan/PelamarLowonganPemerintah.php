...
namespace App\Controller\Dashboard\Lowongan;
 ...
 */
class PelamarLowonganPemerintah extends Controller
{
    /**
     ...
     */
     public function Review(Request $request, Response $response, $routeArgs, $args)
     {
         ...
         if (!$checkJobseeker) {
             ...
             return $this->redirect($response, 'dashboardpemerintah-pelamar');
         }
         ...
         return $this->view->render(
             $response,
             'bkol/dashboard-pemerintah/pelamar/detail-lamaran.twig',
             array(
                 "pelamar" => $pelamar
             )
         );
    ...
    public function apply(Request $request, Response $response)
    {
        ...
        return $this->view->render(
            $response,
            'bkol/dashboard-pemerintah/pelamar/pelamar.twig',
            array(
                "pelamar" => $pelamar->get()
            )
        );
    ...
    public function UndangInterview(Request $request, Response $response, $routeArgs, $args)
    {
      ...
      return $this->view->render(
          $response,
          'bkol/dashboard-pemerintah/pelamar/undang-interview.twig',
          array(
            'pelamar' => $pelamar
          )
      );
    ...
    public function TerimaBekerja(Request $request, Response $response, $routeArgs, $args)
    {
      ...
      return $this->view->render(
          $response,
          'bkol/dashboard-pemerintah/pelamar/terima-bekerja.twig',
          array(
            'pelamar' => $pelamar
          )
      );
