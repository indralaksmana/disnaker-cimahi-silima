...
class ProfilePerusahaan extends Controller
{
    public function profile(Request $request, Response $response)
    {
        ...
        $perusahaan =  BkolPerusahaan::where('user_id',$user_id)->first();
        ...
        if ($request->isPost()) {
            ...
            if ($this->validator->isValid()) {
                ...
                if ($update) {
                    ...
                    $update->jenis_usaha_id = $r['jenis_usaha_id'];
                    $update->no_izin = $r['no_izin'];
                    $update->tahun_berdiri = $r['tahun_berdiri'];
                    $update->companystatus = $r['companystatus'];
                ...
                if (!$update) {
                    ...
                    $add->jenis_usaha_id = $r['jenis_usaha_id'];
                    $add->no_izin = $r['no_izin'];
                    $add->tahun_berdiri = $r['tahun_berdiri'];
                    $add->companystatus = $r['companystatus'];
